...
class PrettyTable(object):
    def __init__(self, field_names=None, **kwargs):
        ...
        self._options.extend(
            "vertical_char horizontal_char junction_char junction_sep header_style valign xhtml print_empty oldsortslice".split())
        ...
        self._junction_sep = kwargs["junction_sep"] or self._unicode(" ")
    ...
    def _validate_option(self, option, val):
        ...
        elif option in ("vertical_char", "horizontal_char", "junction_char", "junction_sep"):
    ...
    @property
    def junction_sep(self):

        return self._junction_sep

    @junction_sep.setter
    def junction_sep(self, val):
        val = self._unicode(val)
        self._validate_option("junction_sep", val)
        self._junction_sep = val
        ...
        for field, width, in zip(self._field_names, self._widths):
            ...
            if options["border"]:
                if options["vrules"] == ALL:
                    ...
                    bits.append(options["junction_sep"])
        ...
        for y in range(0, row_height):
            ...
            if options["border"]:
                if options["vrules"] in (ALL, FRAME):
                    ...
                    bits[y].append(self.junction_sep)
